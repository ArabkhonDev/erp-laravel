<x-app-layout>
    <div class="overflow-hidden rounded-lg border border-gray-200 shadow-md m-5">
        <button class="btn btn-primary m-2 p-2 w-[200px] bg-green-500 rounded text-white-400 hover:text-green-100"><a href="{{route('teachers.create')}}">Create Teacher</a></button>
        <table class="w-full border-collapse bg-white text-left text-sm text-gray-500">
            <thead class="bg-gray-50">
                <tr>
                    <th scope="col" class="px-6 py-4 font-medium text-gray-900">Name</th>
                    <th scope="col" class="px-6 py-4 font-medium text-gray-900">Status</th>
                    <th scope="col" class="px-6 py-4 font-medium text-gray-900">Prof</th>
                    <th scope="col" class="px-6 py-4 font-medium text-gray-900">Phone</th>
                    <th scope="col" class="px-6 py-4 font-medium text-gray-900">Tug'ulgan kuni</th>
                ...
                @foreach ($teachers as $teacher)
                    <tr class="hover:bg-gray-50">
                        <th class="flex gap-3 px-6 py-4 font-normal text-gray-900">
                            <a href="{{route('teachers.show', $teacher->id)}}" class="flex">
                        ...
                        <td class="px-6 py-4">{{ $teacher->birth_date }}</td>
                        <td>
