           ...
           @include('layouts.header')
            ...
            <div class="relative pt-14">
                ...
                <div class="mx-auto max-w-7xl px-6 lg:px-8">
                    ...
                    <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">Join our Academy</h1>
                    <p class="mt-6 text-lg leading-8 text-gray-600">Submi application for study</p>
                    <div class="mt-10 flex items-center justify-center gap-x-6">
                        <a href="#" class="rounded-md bg-cyan-500 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-cyan-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-800">Get started</a>
            ...
            <div class="mx-auto max-w-7xl px-6 lg:px-8">
                ...
                <div class="mt-16 flex justify-center">
                    <p class="relative rounded-full px-4 py-1.5 text-sm leading-6 text-gray-600 ring-1 ring-inset ring-gray-900/10 hover:ring-gray-900/20">
                        ...
                        <a href="#" class="font-semibold text-cyan-400"><span class="absolute inset-0" aria-hidden="true"></span> Read our case study <span aria-hidden="true">&rarr;</span></a>
                    </p>
                </div>
            </div>
        
            <!-- Feature section -->
            <div class="mx-auto mt-32 max-w-7xl px-6 sm:mt-56 lg:px-8" id="feature">
                <div class="mx-auto max-w-2xl lg:text-center">
                    <h2 class="text-base font-semibold leading-7 text-gray-800">Deploy faster</h2>
                    <p class="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Everything  your app</p>
                ...
                <dl class="grid max-w-xl grid-cols-1 gap-x-8 gap-y-10 lg:max-w-none lg:grid-cols-2 lg:gap-y-16">
                    ...
                    <dd class="mt-2 text-base leading-7 text-gray-600">
                        Morbi viverra dui mi arcu sed. Tellus semper adipiscing suspendisse semper morbi. Odio urna massa nunc massa.</dd>
                    </div>
                    <div class="relative pl-16">
                    <dt class="text-base font-semibold leading-7 text-gray-900">
            ...
            <div class="mx-auto mt-32 max-w-7xl sm:mt-56 sm:px-6 lg:px-8">
                ...
                <img class="absolute inset-0 h-full w-full object-cover brightness-150 saturate-0" src="https://www.lifewire.com/thmb/yZ8y7fKEO-TfDv5shoqMei7vlg8=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/how-to-watch-tiktok-without-the-app-08-9d3dc65a8cf34a0d8c72dd518b51eb91.jpg" alt="">
                <div class="absolute inset-0 bg-gray-900/90 mix-blend-multiply"></div>
                <div class="absolute -left-80 -top-56 transform-gpu blur-3xl" aria-hidden="true">
                    <div class="aspect-[1097/845] w-[68.5625rem] bg-gradient-to-r from-[#ff4694] to-[#4ba4ec] opacity-[0.45]" style="clip-path: polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%)"></div>
                </div>
                ...
                <div class="relative mx-auto max-w-2xl lg:mx-0">
                    <img class="h-12 w-auto" src="https://upload.wikimedia.org/wikipedia/en/thumb/a/a9/TikTok_logo.svg/2560px-TikTok_logo.svg.png" alt="">
                    <figure>
                    ...
                    <figcaption class="mt-6 text-base text-white">
                        <div class="font-semibold">Shehab Coding</div>
                    </figcaption>
                    </figure>
                </div>
                </div>
            ...
            <div class="mx-auto max-w-2xl divide-y divide-gray-900/10 px-6 pb-8 sm:pb-24 sm:pt-12 lg:max-w-7xl lg:px-8 lg:pb-32">
                ...
                <div class="pt-8 lg:grid lg:grid-cols-12 lg:gap-8">
                    <dt class="text-base font-semibold leading-7 text-gray-900 lg:col-span-5">What's the best thing in tik tok?</dt>
                    <dd class="mt-4 lg:col-span-7 lg:mt-0">
                    <p class="text-base leading-7 text-gray-600">The best thing about tik tok is that you can get famous and relax by watching it's videos.</p>
                    </dd>
                </div>
            ...
            <div class="relative -z-10 mt-32 px-6 lg:px-8">
                ...
                <div class="mt-10 flex items-center justify-center gap-x-6">
                    <a href="#" class="rounded-md bg-blue-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-red-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Get started</a>
                    <a href="#" class="text-sm font-semibold leading-6 text-gray-900">Learn more <span aria-hidden="true">→</span></a>
                </div>
                </div>
            ...
            <div class="mx-auto mt-32 max-w-7xl px-6 lg:px-8">
                <footer aria-labelledby="footer-heading" class="relative border-t border-gray-900/10 py-24 sm:mt-56 sm:py-32">
                    ...
                    <div class="xl:grid xl:grid-cols-3 xl:gap-8">
                        <a href="{{route('home')}}"><h1>RS Academy</h1></a>
